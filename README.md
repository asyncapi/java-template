...
## Supported protocols
These protocols are implemented using the jms api with the correct jars, in this case ibmmq was chosen. The use of jms allows allows the template to be extensible to other providers by providing the correct jars at the mavern stage.
